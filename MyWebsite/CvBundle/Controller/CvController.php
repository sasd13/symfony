...
use MyWebsite\WebBundle\Entity\MyValue;
use MyWebsite\WebBundle\Entity\MyDate;
...
class CvController extends Controller
{
    ...
    {		
        ...
        $list_categories = $em->getRepository('MyWebsiteWebBundle:Category')->findByCv($cv->getId());
		$tab_list_contenus = array();
		foreach($list_categories as $i => $categorie)
		{
			$tab_list_contenus[$i] = array($categorie->getTag() => $em->getRepository('MyWebsiteWebBundle:Content')->findByCategory($categorie->getId()));
		}
		
		return $this->render('MyWebsiteWebBundle:Cv/cv.html.twig', array(
																				'cv' => $cv,
